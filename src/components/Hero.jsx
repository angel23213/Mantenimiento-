...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-char-900"
    >
      {/* Background layers */}
      ...
      <div className="relative z-20 text-center px-4 flex flex-col items-center">
        {/* Pre-title */}
        <p
          className="font-accent text-fire-400 text-xl mb-4 animate-fade-in"
        ...
        >
          <p className="text-gray-300 font-body text-lg md:text-2xl max-w-md tracking-wide">
            ...
            <span className="text-fire-400">
              Sabor que prende desde el primer mordisco.
            </span>
          </p>
        </div>
